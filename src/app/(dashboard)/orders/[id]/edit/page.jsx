...
export default function CreateOrderPage() {
  ...
  return (
    <>
      <Header title="تعديل بيانات الطلب" subtitle="تعديل تفاصيل الطلب رقم #1234" variant="transparent" />
      
      {/* Page Title & Main Actions */}
      <div className="flex flex-wrap items-center justify-between mb-8 gap-4">
        <div>
          <h2 className="text-[32px] font-black text-[#040814]">تعديل بيانات الطلب</h2>
          <p className="text-gray-500 font-medium mt-2">قم بتحديث أي معلومات متعلقة بهذا الطلب.</p>
        </div>
      </div>
      ...
      <form
        ...
        <div className="w-full lg:w-[70%] space-y-6">
          ...
          <div className="hidden lg:flex gap-4 mt-8">
            ...
            <button 
              type="submit"
              className="flex-1 bg-[#B08B3A] hover:bg-[#906c27] text-white px-6 py-4 rounded-[20px] font-black text-sm transition-colors shadow-lg shadow-amber-500/20 text-center"
            >
              حفظ التعديلات
            </button>
          </div>
