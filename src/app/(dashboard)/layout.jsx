...
function DashboardContent({ children }) {
  ...
  return (
    <div className="min-h-screen bg-[#F4F6F9] text-slate-900 overflow-x-hidden" dir="rtl">
      {/* Sidebar - no more direct props needed */}
      <Sidebar />
      
      {/* Main Content Area */}
      <main className={`min-h-screen transition-all duration-300 md:pr-[100px] w-full`}>
